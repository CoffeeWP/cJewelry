...
if ($woocommerce_installed) {
	class WC_Widget_Cart extends WC_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = __( "Display the user's Cart in the sidebar.", 'cjewelry' );
			$this->widget_id          = 'cjewelry_widget_cart';
			$this->widget_name        = __( 'cJewelry Cart', 'cjewelry' );
			$this->settings           = array(
				'title'  => array(
					'type'  => 'text',
